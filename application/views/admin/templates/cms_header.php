    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion user-sidebar" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin/dashboard'); ?>">
                ...
                <div class="sidebar-brand-text mx-3">CMS ANSORA </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="artikel" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/konten'); ?>">Daftar Artikel</a>
                        <a class="collapse-item" href="<?= base_url('admin/konten/buat_artikel'); ?>">Tambah Artikel</a>
                    </div>
                </div>
            </li>
            <?php if (get_userdata()['id_level'] == '1') { ?>
                <li class="nav-item">
            ...
            <?php if (get_userdata()['id_level'] == '1') { ?>
                ...
                <li class="nav-item">
                    ...
                    <div id="user" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?= base_url('admin/user'); ?>">Daftar User</a>
                            <a class="collapse-item" href="<?= base_url('admin/user/tambah_user'); ?>">Tambah User</a>
                        </div>
                    </div>
                </li>
                </li><?php } ?>
            ...
            <li class="nav-item">
                ...
                <div id="profile" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('admin/profile/index'); ?>">Edit Profile</a>
                        <!-- <a class="collapse-item" href="<?= base_url('admin/user/tambah_user'); ?>">Tambah User</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('admin/profile/portofolio'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= get_userdata()['nama']; ?></span>

                                <img class="img-profile rounded-circle" src="<?= base_url('assets/img/upload/profile/' . get_userdata()['foto']); ?>">
                            </a>
